...
var BufKeyActions = map[string]BufKeyAction{
	...
	"SelectToStartOfSoftLineToggle": (*BufPane).SelectToStartOfSoftLineToggle,
	"SelectToStartOfText":           (*BufPane).SelectToStartOfText,
	"SelectToStartOfTextToggle":     (*BufPane).SelectToStartOfTextToggle,
	"SelectToEndOfLine":             (*BufPane).SelectToEndOfLine,
	"SelectToEndOfSoftLineToggle":   (*BufPane).SelectToEndOfSoftLineToggle,
...
var MultiActions = map[string]bool{
	...
	"SelectToStartOfSoftLineToggle": true,
	"SelectToStartOfText":           true,
	"SelectToStartOfTextToggle":     true,
	"SelectToEndOfLine":             true,
	"SelectToEndOfSoftLineToggle":   true,
