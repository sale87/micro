...
var optionValidators = map[string]optionValidator{
	...
	"focusmode":       validateChoice,
	"focusstrength":   validateNonNegativeValue,
	"helpsplit":       validateChoice,
	"matchbracestyle": validateChoice,
	"multiopen":       validateChoice,
	"padleft":         validateNonNegativeValue,
	"padhorizontal":   validateNonNegativeValue,
	"padright":        validateNonNegativeValue,
